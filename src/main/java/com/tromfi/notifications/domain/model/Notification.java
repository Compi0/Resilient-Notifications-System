...
public class Notification {
    ...
    // TODO Crear una factory de rehidratar objetos,
    // Solo que aqui no podemos volver a mandar el entity porque estaria rompiendo hexagonal?
    public static Notification fromPersistence(
            Long id, String content, int attemptCount, String recipient, MessageTypes messageTypes, MessageStatus messageStatus, MessageUrgency messageUrgency,
            LocalDateTime createdAt, LocalDateTime updatedAt, LocalDateTime nextAttemptAt
    ){
    ...
    public LocalDateTime calculateNextAttempt(){
        ...
        if(this.attemptCount > this.MAX_ATTEMPTS){
            ...
            this.messageStatus = MessageStatus.RETRYING;
